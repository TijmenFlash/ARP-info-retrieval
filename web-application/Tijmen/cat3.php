	...
	<head>
 	...
 	<body onload="setStatusItems()">
 		...
 		<div class="unselectable" id="categories-div">
 			...
 			<div onClick="location.href='search.php?q=creatief'" class='categories'><div class="categorie_part_a"><img style="width:100%;" src='src/crafting.jpg'/></div><div class="categorie_part_b">Creative</div></div>
 			</div>
 		<!--status footer-->
