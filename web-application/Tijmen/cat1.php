	...
	<head>
 	...
 	<body onload="setStatusItems()">
 		...
 		<div class="unselectable" id="categories-div">
 			...
 			<div onClick="location.href='search.php?q=query1'" class='categories'><div class="categorie_part_a"><img style="width:100%;" src='src/placeholder.jpg'/></div><div class="categorie_part_b">sub cat 1</div></div>
 			<div onClick="location.href='search.php?q=query2'" class='categories'><div class="categorie_part_a"><img style="width:100%;" src='src/placeholder.jpg'/></div><div class="categorie_part_b">Sub cat 2</div></div>
 			</div>
 		<!--status footer-->
