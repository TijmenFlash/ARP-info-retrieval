	...
	<head>
 	...
 	<body onload="setStatusItems()">
 		...
 		<div class="unselectable" id="categories-div">
 			...
 			<div onClick="location.href='search.php?q=xbox'" class='categories'><div class="categorie_part_a"><img style="width:100%;" src='src/placeholder.jpg'/></div><div class="categorie_part_b">Xbox</div></div>
 			<div onClick="location.href='search.php?q=playstation'" class='categories'><div class="categorie_part_a"><img style="width:100%;" src='src/placeholder.jpg'/></div><div class="categorie_part_b">Playstation</div></div>
 			<div onClick="location.href='search.php?q=wii'" class='categories'><div class="categorie_part_a"><img style="width:100%;" src='src/placeholder.jpg'/></div><div class="categorie_part_b">Wii</div></div>
 		</div>
 		<!--status footer-->
